...
// function renderImage(resolution, config) {
// 	var _this = this;
// 	config = config || {};
// 	var step = 1 / (resolution - 1);
// 	var img = [];
...
// function _calculateValue(coord, k, distFn) {
// 	let minDist;
